...
public class SlidingPuzzle {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Total Moves = "+slidingPuzzle(board1));
        System.out.println();

        System.out.println("----------------Test Case 2----------------------");
        int [][] board2 = {{1,2,3},{5 ,4,0}};
        System.out.println("Total Moves = "+slidingPuzzle(board2));
        System.out.println();

        System.out.println("----------------Test Case 3----------------------");
        int [][] board3 = {{4, 1,2},{5,0,3}};
        System.out.println("Total Moves = "+slidingPuzzle(board3));
        System.out.println();

        System.out.println("----------------Test Case 4----------------------");
        int [][] board4 = {{3,2,4},{1,5,0}};
        System.out.println("Total Moves = "+slidingPuzzle(board4));
        System.out.println();
    }
    ...
    private static int swap(int state, int zeroIdx, int destIdx) {
